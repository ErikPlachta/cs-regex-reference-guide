...
This is a general reference guide on how to understand and use some basic Regex Expressions. I've broken down specific functions below with basic examples and real-life scenarios where the associted regex expression would be useful.
...
"*Regular expressions are patterns used to match character combinations in strings.*" - [MDN - Regular Expressions](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular_Expressions)
